    ...
    <div className="home-wrapper">
      ...
      <section className="how-it-works" id="how-it-works" style={{ padding: '100px 5%', background: '#f8fafc' }}>
        ...
        <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', maxWidth: '1200px', margin: '48px auto' }}>
          {[
            { step: '1', title: 'Seller Records', desc: 'Seller adds a new credit transaction for a customer.' },
            { step: '2', title: 'Consumer Notified', desc: 'The customer receives an instant notification to review.' },
            { step: '3', title: 'Approval', desc: 'Customer accepts the credit to confirm the debt.' },
            { step: '4', title: 'Trust Built', desc: 'Successful payments improve the customer trust score.' }
          ].map((item, idx) => (
