      ...
      <div className="main-content-wrapper">
        <nav className="top-navbar-modern">
          <div className="navbar-search-modern">
            <span>🔍</span>
            <input type="text" placeholder={t('seller.search_placeholder_seller')} />
          </div>
          <div className="navbar-actions-modern">
            <button className="icon-btn-modern" title={t('common.notifications')}>🔔</button>
            <button className="icon-btn-modern" title={t('common.settings')}>⚙️</button>
          </div>
        </nav>
