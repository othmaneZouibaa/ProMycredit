        ...
        <div className="consumers-list-container">
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <div className="action-btns-cell">
                                            ...
                                            <button className="icon-action-btn" title="View Details" onClick={() => navigate(`/seller-panel/consumer/${item.id}`)}>
                                                👁️
                                            </button>
                                        </div>
                                    </td>
            ...
            {showEditModal && (
                <div className="modal-overlay-modern">
                    <div className="modal-content-modern">
                        <h3>Edit Consumer</h3>
                        <p>Updating profile for <strong>{selectedConsumer?.name}</strong></p>
