...
class ConsumerDashboardController extends Controller
{
    ...
    public function stats(Request $request)
    {
        ...
        if ($avgTrustScore < 90) {
            ...
            $productName = $firstCredit ? (is_array($firstCredit) ? $firstCredit['product_name'] : $firstCredit->product_name) : null;
            
            $trustAnalysis['tips'][] = [
                'key' => 'tip_pay_upcoming',
                'params' => ['product' => $productName ?? 'credit']
            ];
            $trustAnalysis['tips'][] = [
                'key' => 'tip_keep_debt_low',
                'params' => ['amount' => '5,000']
            ];
        } else {
            $trustAnalysis['tips'][] = [
                'key' => 'tip_excellent_score',
                'params' => []
            ];
        }
